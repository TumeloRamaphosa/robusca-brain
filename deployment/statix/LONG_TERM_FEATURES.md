...
## Phase 0 — TODAY (MVP / 3-hour launch)
...
| Polsia webhook stub | Built |
| Docker + Fly deploy path | Built |
| Cloudflare DNS guide | Documented |

---

## Phase 1 — Week 1 (Connected product)
...
## Phase 2 — Month 1 (Full NestVM)

| Feature | Description |
|---|---|
| **Real VM provisioning** | Orgo / Fly / Polsia NestVM API — `nestvm create` |
| **8 Super Agents live** | n8n workflows on tenant VM |
...
## Phase 3 — Month 2–3 (Voice + Edge)

| Feature | Description |
|---|---|
| **RileyJarvis voice shell** | Animated face, artifacts, realtime speech |
| **Tauri desktop** | Windows + Mac native app |
| **PWA mobile** | Installable on phone |
| **Tiiny integration** | Auto-discover edge device, local inference |
| **NestVM Edge Box** | Shenzhen OEM, Studex-branded |
| **Offline mode** | Tiiny local → sync when online |

---

## Phase 4 — Month 4–6 (Enterprise + Global Markets)
...
| **Series A readiness** | R25M ARR, ART DC pipeline |

---

## Customer voice touchpoints (long-term)

Every customer hears Soul (or their persona) at:

1. **Landing** — welcome voice companion  
2. **Onboarding** — 5 spoken steps + WhatsApp parallel  
3. **Daily** — WhatsApp morning brief (voice note option)  
4. **Dashboard** — voice reads activity + approvals  
5. **Founder Circle** — Tumelo + Soul co-host intro  
6. **Tiiny / Edge** — local TTS, no cloud latency  
7. **Support** — WhatsApp voice reply from agent  
8. **Upgrade** — spoken Global Markets invitation  
