...
```bash
# Claude Code (after install.sh): ~/.claude/skills/goal/scripts/claude_goal.py
# Cursor / this repo:
python3 skills/goal/scripts/claude_goal.py invoke "$ARGUMENTS"
```
...
```bash
python3 skills/goal/scripts/claude_goal.py complete
```
